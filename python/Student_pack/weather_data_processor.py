...
class WeatherDataProcessor:
    ...
    * calculate_means.
    ...
    def weather_station_mapping(self):
        """Gets access to the weather data and save it a DataFrame."""
    ...
    def extract_measurement(self, message):
        ...
        Args:
            message (str): text message to be searched in.

        Returns:
            tuple: result key and match groups.
        """
    ...
    def process_messages(self):
        """Process extracting the measurements.

        Returns:
            DataFrame: return a DataFrame with all measures extracted.
        """
    ...
    def calculate_means(self):
        """Calculate the means for all measurements.

        Returns:
            DataFrame: Return a DataFrame for all measurements means.
        """
        if self.weather_df is not None:
